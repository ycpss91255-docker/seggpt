...
```
seggpt/
├── docker/                      Docker environment (base subtree)
│   ├── .base/                   git subtree from ycpss91255-docker/base
│   ├── Dockerfile               per-repo Dockerfile
│   ├── compose.yaml             auto-generated by setup.sh (do not edit)
│   ├── config/docker/setup.conf per-repo runtime configuration (layered over .base/config/docker/setup.conf)
